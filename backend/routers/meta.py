    ...
    return {
        "fields": [
            ...
            {"key": "takrar", "label": {"ar": "تتكرر الرؤيا", "en": "Recurring"},
             "values": [{"ar": "نعم", "en": "Yes"}, {"ar": "نعم، مراراً", "en": "Yes, several times"},
                        {"ar": "لا", "en": "No"}]},
            {"key": "waqt", "label": {"ar": "وقت الرؤيا", "en": "Time of the dream"},
             "values": [{"ar": "أول الليل", "en": "Early night"},
                        {"ar": "آخر الليل", "en": "Before dawn"},
                        {"ar": "بعد الفجر", "en": "After fajr"},
                        {"ar": "القيلولة", "en": "Daytime nap"}]},
            # The four below are weighed by the tradition itself, so they are
            # marked `weighed` and the form gives them their own emphasis.
            {"key": "istikhara", "label": {"ar": "صلاة الاستخارة قبلها", "en": "Istikhara prayer beforehand"},
             "weighed": True,
             "values": [{"ar": "نعم", "en": "Yes"}, {"ar": "لا", "en": "No"},
                        {"ar": "لم يُذكر", "en": "Not mentioned"}]},
            {"key": "wuduh", "label": {"ar": "وضوح التفاصيل", "en": "Clarity of details"},
             "weighed": True,
             "values": [{"ar": "واضحة جداً", "en": "Very clear"},
                        {"ar": "متوسطة", "en": "Somewhat clear"},
                        {"ar": "مشوّشة", "en": "Hazy"}]},
            {"key": "qabl", "label": {"ar": "حالك قبل النوم", "en": "State before sleep"},
             "weighed": True,
             "values": [{"ar": "مطمئن", "en": "Settled"},
                        {"ar": "مرهق وكثير التفكير", "en": "Exhausted, racing thoughts"},
                        {"ar": "على وضوء وذكر", "en": "In wudu, remembering God"},
                        {"ar": "بعد خصام أو ضيق", "en": "After conflict or distress"}]},
            {"key": "makan", "label": {"ar": "هل كان المكان مألوفاً", "en": "Was the place familiar"},
             "weighed": True,
             "values": [{"ar": "نعم، مكاني المعتاد", "en": "Yes, my own place"},
                        {"ar": "مكان أعرفه", "en": "Somewhere I know"},
                        {"ar": "مكان غريب", "en": "A strange place"}]},
        ],
