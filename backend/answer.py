...
٤- **تكلّم على الرؤيا كلاماً متصلاً في `tahlil_mufassal` قبل أن تُفرد الرموز.**
   ...
   - وصدّر كل معنى بدلالته في كتب التعبير ما وُجدت في النصوص المرفقة، **وسمِّ
     ...
     فإن السائل جاء ليعرف ما قالته الكتب لا ما يخطر لك.
     **فإن اختار السائل مرجعية واحدة فلا تسمِّ سواها البتة**، وانظر ما تقدّم
     في أول الطلب من لزوم مسلكها وحده. فإن لم يكن في النصوص شيء فقل ما استقر عند أهل التعبير
