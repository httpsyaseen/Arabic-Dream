...
const T = {
  ar: {
    ...
    manhaj: "مسلك التأويل", masadir: "المصادر",
    ...
    faqH1: "أسئلة شائعة",
    recurring: "رموز تتكرر في رؤاك:",
    skip: "تخطَّ إلى المحتوى",
    page: "ص", sourceLink: "المصدر",
  ...
  en: {
    ...
    recurring: "Symbols recurring in your dreams:",
    skip: "Skip to content",
    page: "p.", sourceLink: "source",
...
function renderReading(d, prefix = "") {
  ...
  if (!a) {
    ...
    // aloud — the reader already knows what they dreamt, so nothing here quotes
